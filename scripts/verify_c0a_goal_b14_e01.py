#!/usr/bin/env python3
"""Recompute frozen b14 inference and validate all 32 fresh E01 branch artifacts."""
from pathlib import Path
import json
import sys
import torch
from evaluate_c0a_goal_b14_e01 import BASE, TARGET_SLOT_IDS, file_sha256, validate_branch, summarize, write_json, weighted_type_score
...
def main():
    ...
    for path,sha in protocol['code_sha256'].items():
        ...
        code_checks+=1
    source_checks=0
    for key in ['teacher_checkpoint','scenario','manifest','seed_boundary_source','training_protocol','previous_b13_protocol']:
        sha_key={'teacher_checkpoint':'teacher_sha256','scenario':'scenario_sha256','manifest':'manifest_sha256','seed_boundary_source':'seed_boundary_source_sha256','training_protocol':'training_protocol_sha256','previous_b13_protocol':'previous_b13_protocol_sha256'}[key]
