...
missileLLA = UtilsPy.Vector3D(121.95459533365242, 27.638757621441638, 10001.165784196928)
missileEcf = CoordinateHelper.llaToEcef_py(missileLLA)
targetLLA = UtilsPy.Vector3D(123.962171, 27.526693, 0)
...
cruise.Launch(UtilsPy.Vector3D(124.625763, 27.482257, 0))
...
for i in range(int(500 / step)):
    ...
    if i == int(50 / step):
        print("he")
        cruise.SetDesiredAccZ(20 * 9.8)
    if i == int(81.5 / step):
        print("he")
        cruise.SetDesiredAccZ(0)
